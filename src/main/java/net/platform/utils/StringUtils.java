...
public class StringUtils {
    ...
    /**
     * 
     * 功能描述：将传入的ID列表转换成数据库的字符串，如：'aaaa','bbbb'
     * 
     * @author 
     * 
     *        <p>
     *        创建日期 ：2016-7-18 下午04:47:38
     *        </p>
     * @param strList
     * @return String
     */
    ...
    /**
     * 
     * 功能描述：数字字符串转化为整数，在转化时发生异常，则返回0
     * 
     * @author 
     * 
     *        <p>
     *        创建日期 ：2016-7-18 下午04:47:59
     *        </p>
     * @param srcStr
     * @return int
     */
    ...
    /**
     * 
     * 功能描述：数字字符串转化为双精数字，在转化时发生异常，则返回0
     * 
     * @author 
     * 
     *        <p>
     *        创建日期 ：2016-7-18 下午04:48:30
     *        </p>
     * @param srcStr
     * @return double
     */
    ...
    /**
     * 
     * 功能描述：数字字符串转化为长整型，在转化时发生异常，则返回0
     * 
     * @author 
     * 
     *        <p>
     *        创建日期 ：2016-7-18 下午04:48:44
     *        </p>
     * @param srcStr
     * @return long
     */
    ...
    /**
     * 
     * 功能描述：双精数字格式化，把入参中的双精数格式化为带两位小数的数字字符串
     * 
     * @author 
     * 
     *        <p>
     *        创建日期 ：2016-7-18 下午04:49:25
     *        </p>
     * @param db
     * @return String
     */
     ...
     * @return
     */
    public static String getSplitToBitOrInt(String var_, String joint, boolean bitType) {
        StringBuffer srcResult = new StringBuffer("");
        if (org.apache.commons.lang3.StringUtils.isNotBlank(var_)
                && org.apache.commons.lang3.StringUtils.isNotBlank(joint)) {
            String[] var = var_.split(joint);
            int rs = 0;
            for (String s : var) {
            ...
            if (bitType) {
                srcResult.append(Integer.toBinaryString(rs));
            } else {
                srcResult.append(String.valueOf(rs));
            }
        }
        return srcResult.toString();
    }
    ...
    public static void main(String[] args) {
        String result = replaceString("abkabkAb", "ab", "hh", false);
    }

    /**
     * 
     * @param realName
     * @author linyt@foxmail.com
     * @return
     */
